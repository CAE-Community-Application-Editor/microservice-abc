 ...
 * abc - Test Class
 *
 * This class provides a basic testing framework for the microservice abc. It was
...
public class aTest {
  ...
  private static final String mainPath = "/x";
  ...
  public void testa() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "//y", "",
